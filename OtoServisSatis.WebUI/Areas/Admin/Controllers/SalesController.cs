...
namespace OtoServisSatis.WebUI.Areas.Admin.Controllers
{
    ...
    public class SalesController : Controller
    {
        ...
        private readonly IService<Musteri> _servicMusteri;

        public SalesController(IService<Satis> service, IService<Arac> serviceArac, IService<Musteri> servicMusteri)
        {
            _service = service;
            _serviceArac = serviceArac;
            _servicMusteri = servicMusteri;
        }
        ...
        public async Task<ActionResult> CreateAsync()
        {
            ...
            ViewBag.MusteriId = new SelectList(await _servicMusteri.GetAllAsync(), "Id", "Adi");
            return View();
        }
